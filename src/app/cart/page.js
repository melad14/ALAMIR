...
//       if (response.ok) {
//         // Cash payment successful, redirect to the same path as online payment
//         const data = await response.json();
//         window.location = data.redirectUrl; // Assuming your API returns the redirect URL
//         toast.success('Cash payment successful');
//       } else {
...
//                 paymentMethod === "online" ? "bg-primary text-white" : "bg-gray-300"
//               }`}
//               onClick={() => handlePaymentMethodChange("online")}
//             >
//               Online Payment
...
//             <button
//               className={`px-4 py-2 rounded ${
//                 paymentMethod === "cash" ? "bg-primary text-white" : "bg-gray-300"
//               }`}
//               onClick={() => handlePaymentMethodChange("cash")}
//             >
//               Cash Payment
